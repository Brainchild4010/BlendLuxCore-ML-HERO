...
class LuxCoreDenoiser(PropertyGroup):
    ...
    # OptiX settings
    optix_min_samples: IntProperty(name="Minimum Samples", default=0, min=0, soft_max=64,
                                   description="Minimum number of samples per pixel before running the NVIDIA OptiX denoiser")
    optix_sharpness: FloatProperty(name="Sharpness", default=0.1, min=0.0, soft_max=1.0,
                                   description="Additional sharpness control for the NVIDIA OptiX denoiser")

...
class LuxCoreConfig(PropertyGroup):
    ...
    ml_hero_sampling_mode: EnumProperty(
        name="HERO Sampling",
        items=[
            ("1", "Sampling 1.0 - Linear", "Current uniform 16-strata HERO wavelength sampling", 0),
            ("2", "Sampling 2.0 - CIE Weighted", "Experimental HERO Sampling 2.0", 1),
            ("3", "Sampling 3.0 - Sensor Weighted", "RGB sensor-weighted HERO wavelength sampling", 2),
        ],
        default="1",
    ...
    ml_hero_enable: BoolProperty(
        ...
        description=(
            ...
            "enabled uses ML HERO path-wavelength transport"
        ),
    )
    ...
    sinc_tau: FloatProperty(name="Sinc Filter Tau", default=3.0, min=0.01, max=8)

...
def convert_viewport_engine(context, scene, definitions, config):
    ...
    if utils.using_bidir_in_viewport(scene):
        ...
        definitions["path.russianroulette.depth"] = config.bidir_rr_depth
        definitions["path.russianroulette.cap"] = config.bidir_rr_cap
...
def _convert_path(
    ...
    definitions["path.russianroulette.depth"] = path.rr_depth
    definitions["path.russianroulette.cap"] = path.rr_cap
